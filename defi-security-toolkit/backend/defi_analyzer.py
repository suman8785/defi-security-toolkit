...
class DeFiAnalyzer:
    ...
    def _analyze_price_impact(self, content: str) -> Dict[str, Any]:
        ...
        # Check for large trade warnings
    ...
    def _check_collateral_ratios(self, content: str) -> Dict[str, Any]:
        ...
        # Extract collateral-related values
        ...
        safety_margin = None
        if cf_value and lt_value:
            safety_margin = lt_value - cf_value
        
        return {
            'collateral_factor': cf_value,
            'liquidation_threshold': lt_value,
            'safety_margin': safety_margin,
            'is_safe': safety_margin > 500 if safety_margin else False,  # 5% minimum margin
    ...
    def _check_interest_model(self, content: str) -> Dict[str, Any]:
        ...
        # Look for interest rate calculations
        ...
        # Check for utilization-based rates
